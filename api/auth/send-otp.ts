import { resolveSendOtpRequest } from "../../src/lib/otpAuth.server";
...
export default async function handler(
  ...
  await handleAuthApiRequest(req, res, (body, context) => resolveSendOtpRequest(process.env, body, context));
}

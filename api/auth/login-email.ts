import { resolveEmailLoginRequest } from "../../src/lib/otpAuth.server";
...
export default async function handler(
  ...
  await handleAuthApiRequest(req, res, (body, context) => resolveEmailLoginRequest(process.env, body, context));
}

import { resolveRefreshSessionRequest } from "../../src/lib/otpAuth.server";
...
export default async function handler(
  ...
  await handleAuthApiRequest(req, res, (body, context) => resolveRefreshSessionRequest(process.env, body, context));
}

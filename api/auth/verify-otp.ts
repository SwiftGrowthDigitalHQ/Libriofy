import { resolveVerifyOtpRequest } from "../../src/lib/otpAuth.server";
...
export default async function handler(
  ...
  await handleAuthApiRequest(req, res, (body, context) => resolveVerifyOtpRequest(process.env, body, context));
}
